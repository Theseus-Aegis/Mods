...
class CfgWeapons
{
	...
	class bnae_falkor_base: Rifle_Long_Base_F // https://www.falkordefense.com/rifles/petra/
	{
        initSpeed = -1.0;
...
{
	class CA_Magazine;
    class 10Rnd_300WM_Magazine: CA_Magazine // AtragMx GunList ".300WM Berger OTM"
	{
...
{
	class BulletBase;
	class B_300WM_Ball: BulletBase // https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L292
	{
